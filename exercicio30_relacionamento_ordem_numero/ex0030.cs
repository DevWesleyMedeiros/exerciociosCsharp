...
public static class Ex0030{
    ...
    public static void Main(){
        ...
        if(v1 == v2 && v2 == v1){
            ...
            Console.WriteLine("O valores não são iguais");
        }else if(v1 >= v2 && v2 <= v1){
            Console.WriteLine("{0} é maior ou igual a {1}", v1, v2);
        }else if(v2 >= v1 && v1 <= v2){
            Console.WriteLine("{0} é maior ou igual a {1}", v2, v1);
        }
        Console.WriteLine("O maior entre {0} e {1} é {2}", v1, v2, Math.Max(v1, v2));
        Console.WriteLine("O menor entre {0} e {1} é {2}", v1, v2, Math.Min(v1, v2));
    }
}